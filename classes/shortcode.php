...
class TMM_Shortcode {
	...
	public static function register() {
		...
		self::$shortcodes['price_table'] = esc_html__('Price table', TMM_CC_TEXTDOMAIN);
		self::$shortcodes['google_table_row'] = esc_html__('Google table row', TMM_CC_TEXTDOMAIN);
...
//			echo nl2br(var_dump($atts) . "\n\n");
//
//			echo nl2br(var_dump($content));
