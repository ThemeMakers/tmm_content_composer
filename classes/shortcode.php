...
class TMM_Shortcode {
	...
	public static function register() {
		...
		self::$shortcodes['price_table'] = esc_html__('Price table', 'tmm_content_composer');
		self::$shortcodes['google_table_row'] = esc_html__('Google table row', 'tmm_content_composer');
