                    ...
                    switch ($input['type']) {
                        ...
                        case "select":
                            ...
                            <p class="input-block sel">
	                            <label for="url_<?php echo $unique_id ?>"><?php echo esc_html($input['label']) ?><?php echo($input['is_required'] ? ': <span class="required">(' . esc_html__('required', TMM_CC_TEXTDOMAIN) . ')</span>' : '') ?></label>
