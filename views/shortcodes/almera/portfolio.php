        ...
        <?php if (!empty($images)): ?>
            <?php foreach ($images as $image): ?>
                ...
                <article class="box <?php echo $effect_class; ?> <?php echo $col ?>">
                    ...
                    <div class="project-thumb animTop <?php if (!$folio_slide_up) echo 'links' ?>">

                        <a href="<?php echo $image['imgurl'] ?>" class="single-image plus-icon <?php echo $icon_class ?> <?php echo $video_icon ?>"
                           title="<?php echo $t=((TMM::get_option('hide_image_titles'))=='0') ? $image['title'] : '' ?>"
                           data-fancybox-group="masonry">
                            <img alt="" <?php if ($folio_slide_up) echo 'class="slideup"'; ?>
                        ...
                        <?php if ($folio_slide_up) {
                            ?>
                            <a href="<?php echo $title_href = (!empty($image['title_href'])) ? $image['title_href'] : get_permalink($post_id); ?>"
                               class="project-meta">
                        ...
                        <?php
                            ...
                            <a class="gr-link single-image link-icon"
                               href="<?php echo $title_href = (!empty($image['title_href'])) ? $image['title_href'] : get_permalink($post_id); ?>"></a>
                        <?php
                        } ?>
            ...
            <?php if (!empty($folioposts_array)): ?>
                <div id="masonryjaxloader" data-slideup="<?php echo $folio_slide_up; ?>" data-icons="<?php echo $icons_type ?>" data-next-post-key="1" data-posts="<?php echo $folioposts ?>" data-col-algoritm="<?php echo $current_col_algoritm ?>"></div>
            <?php endif; ?>
...
if (count($folioposts_array)>1){
    ?>
    <a href="javascript:masonry_scroll(true);void(0);" class="masonry_view_more_button"><?php _e('More', 'tmm_shortcodes'); ?></a>
<?php
}
wp_reset_query();
