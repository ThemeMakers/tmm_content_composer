...
if ($show_sidebar && $sidebar_position === 'left') {
    ...
    if (function_exists('dynamic_sidebar')) {
        dynamic_sidebar('cars_slider_sidebar');
    }
...
foreach ($featured_cars as $car_id => $car) {
            ...
            ?>
						...
						<li<?php if (!$placeholder) {
                echo ' class="resized"' . ' style="width:' . $slider_size['width'] . 'px;height:' . $slider_size['height'] . 'px;"';
            }
            ?>>
...
$slider_opts = array(
    ...
    ?>
		...
		<div class="wrapper-slider <?php echo esc_attr($show_sidebar ? 'two-thirds' : '') ?>">
			<?php
