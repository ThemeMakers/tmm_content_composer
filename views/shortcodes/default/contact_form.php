	...
	<form method="post" class="contact-form" enctype="multipart/form-data">
        ...
        foreach ($contact_form['inputs'] as $key => $input){
            ...
            switch ($input['type']) {
	            ...
	            case 'title':
                    ...
                    if (!isset($input['title_heading'])) {
                        $input['title_heading'] = 'h3';
                    }
		            ?>
        ...
        <?php if ($contact_form['has_capture']){ ?>
            ...
            <p class="tmmFormStyling form-captcha">
				...
				<img class="contact_form_capcha" src="<?php echo get_stylesheet_directory_uri(); ?>/helper/capcha/image.php?hash=<?php echo $hash ?>"/>
