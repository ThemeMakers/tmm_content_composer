		...
		<?php foreach ($contact_form['inputs'] as $key => $input) : ?>
			...
			switch ($input['type']) {
				...
				case "email":
					?>
					<p class="input-block">
						<label for="email_<?php echo $unique_id ?>"><?php esc_html_e($input['label'], 'tmm_content_composer'); ?><?php echo($input['is_required'] ? ': <span class="required">*</span>' : '') ?></label>
				...
				case "textinput":
					?>
					<p class="input-block">
						<label for="name_<?php echo $unique_id ?>"><?php esc_html_e($input['label'], 'tmm_content_composer'); ?><?php echo($input['is_required'] ? ': <span class="required">*</span>' : '') ?></label>
				...
				case "website":
					?>
					<p class="input-block">
						<label for="url_<?php echo $unique_id ?>"><?php esc_html_e($input['label'], 'tmm_content_composer'); ?><?php echo($input['is_required'] ? ': <span class="required">*</span>' : '') ?></label>
				...
				case "messagebody":
					...
					?>
					<p class="input-block">
						<label for="message_<?php echo $unique_id ?>"><?php esc_html_e($input['label'], 'tmm_content_composer'); ?><?php echo($input['is_required'] ? ': <span class="required">*</span>' : '') ?></label>
				...
				case "select":
					...
					?>
					<p class="input-block">
						<label for="sel_<?php echo $unique_id ?>"><?php esc_html_e($input['label'], 'tmm_content_composer'); ?><?php echo($input['is_required'] ? ': <span class="required">*</span>' : '') ?></label>
						<select id="sel_<?php echo $unique_id ?>" name="<?php echo $name ?>">
							<?php if (!empty($select_options)): ?>
								<?php foreach ($select_options as $value) : ?>
									<option value="<?php echo $value; ?>"><?php esc_html_e($value, 'tmm_content_composer'); ?></option>
								<?php endforeach; ?>
							<?php endif; ?>
						</select>
					</p>
