...
?>
<div id="chart_<?php echo esc_attr($unique_id); ?>" style="width: <?php echo $width ?>px; height: <?php echo $height ?>px;"></div>
<?php
switch ($type) {
	case 'pie':
		...
		<script type="text/javascript">
			...
			function <?php echo "drawPieChart" . $unique_id; ?>() {
				var data = google.visualization.arrayToDataTable([
					...
					var chart = new google.visualization.PieChart(document.getElementById('chart_<?php echo esc_js($unique_id); ?>'));
