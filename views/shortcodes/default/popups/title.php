...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="one-half">
		...
		<div class="one-half inner-left">
			<h4 class="label"><?php _e( 'Text Transformation', 'tmm_content_composer' ); ?></h4>
			<?php
			TMM_Content_Composer::html_option( array(
				'type'            => 'checkbox',
				'title'           => __( 'Uppercase', 'tmm_content_composer' ),
	...
	<div class="one-half">
		...
		<div class="one-half inner-right">
			...
			TMM_Content_Composer::html_option( array(
				'type'            => 'text',
				'title'           => __( 'Bottom Offset (px)', 'tmm_content_composer' ),
		...
		<div class="one-half inner-right">
			<?php
			TMM_Content_Composer::html_option( array(
				'title'           => __( 'Custom Color', 'tmm_content_composer' ),
...
<script type="text/javascript">
	...
	jQuery(function () {
		...
		jQuery('#title_type').on('keyup change', function(){
