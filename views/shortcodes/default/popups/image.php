...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="one-half">
		...
		<div id="target_url" style="display: <?php echo($action == 'none' ? 'none' : 'block') ?>;">
			...
			TMM_Content_Composer::html_option(array(
				'type' => 'checkbox',
				'title' => __('Open original image size in lightbox', 'tmm_content_composer'),
				'shortcode_field' => 'lightbox',
				'id' => 'lightbox',
				'is_checked' => TMM_Content_Composer::set_default_value('lightbox', 0),
				'description' => ''
			));
			?>
