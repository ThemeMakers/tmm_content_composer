...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="one-half">
		...
		TMM_Content_Composer::html_option(array(
			'type' => 'text',
			'title' => esc_html__('Top Indent (px)', 'tmm_content_composer'),
	...
	<div class="one-half">
		...
		TMM_Content_Composer::html_option(array(
			'type' => 'text',
			'title' => esc_html__('Right Indent (px)', 'tmm_content_composer'),
	...
	<div class="one-half">
		...
		TMM_Content_Composer::html_option(array(
			'type' => 'text',
			'title' => esc_html__('Left Indent (px)', 'tmm_content_composer'),
