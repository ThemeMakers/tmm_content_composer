...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="fullwidth">
		...
		<a class="button button-small js_add_accordion_item" href="#"><?php _e('Add item', 'tmm_content_composer'); ?></a><br />
					...
					<table style="width: 100%;">
						<tr>
							<td valign="top" style="width: 100%;">
								...
								&nbsp;<a class="button button-small js_delete_accordion_item js_shortcode_template_changer" href="#"><?php _e('Remove', 'tmm_content_composer'); ?></a>
							</td>
						</tr>
						<tr>
							<td valign="top" style="width: 100%;" colspan="2">
								<textarea placeholder="Content" class="accordion_item_content js_shortcode_template_changer data-area" placeholder="<?php _e('Content', 'tmm_content_composer'); ?>"><?php echo $content_edit_text ?></textarea>
							</td>
						</tr>
					</table>
				</li>
