					...
					<table style="width: 100%;">
						...
						<tr>
							<td valign="top" style="width: 100%;" colspan="2">
								<textarea placeholder="Content" class="accordion_item_content js_shortcode_template_changer data-area" placeholder="<?php esc_html_e('Content', TMM_CC_TEXTDOMAIN); ?>"><?php echo $content_edit_text ?></textarea>
							</td>
						</tr>
					</table>
				</li>
