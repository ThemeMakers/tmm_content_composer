...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
    ...
    <div class="fullwidth">
        ...
        <a class="button button-small js_add_accordion_item"
           href="#"><?php _e('Add item', TMM_CC_TEXTDOMAIN); ?></a><br/>
            ...
            <?php foreach ($content_edit_data as $key => $content_edit_text) : ?>
                <li class="list_item">
                    <table width="100%">
                        <tr>
                            <td valign="top">
                                <input placeholder="Title" type="text" value="<?php echo $titles_edit_data[$key] ?>"
                                       class="accordion_item_title js_shortcode_template_changer" style="width: 67%;"/>
                                &nbsp;<a
                                        class="button button-small js_delete_accordion_item js_shortcode_template_changer"
                        ...
                        <tr>
                            <td valign="top">
                                <textarea placeholder="Content" rows="3"
                                          class="accordion_item_content js_shortcode_template_changer data-area"
                                          placeholder="<?php _e('Content', TMM_CC_TEXTDOMAIN); ?>"><?php echo $content_edit_text ?></textarea>
                            </td>
                        </tr>
                    </table>
                </li>
