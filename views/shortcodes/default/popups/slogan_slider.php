...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
        ...
        <div class="one-half">
			...
			'type' => 'select',
			'title' => esc_html__('Slider type', TMM_CC_TEXTDOMAIN),
	...
	<div class="fullwidth">
        <br />
		<a class="button button-secondary js_add_text_slider_item" href="#"><?php esc_html_e('Add item', TMM_CC_TEXTDOMAIN); ?></a><br />
		...
		<ul id="list_items" class="list-items">
			...
			<?php  foreach ($h1_edit_data as $key => $h1){ ?>
				<li class="list_item">
                                        <a class="button button-secondary js_delete_text_slider_item js_shortcode_template_changer" href="#"><?php esc_html_e('Remove', TMM_CC_TEXTDOMAIN); ?></a>
					<table class="list-table">
						<tr>
							<td style="width:22%">
                                ...
                                TMM_Content_Composer::html_option(array(
                                            'type' => 'text',
                                            'title' => esc_html__('Title Text 1', TMM_CC_TEXTDOMAIN),
                                            'shortcode_field' => '',
                                            'id' => '',
                                ...
                                <td style="width:15%">
                                    ...
                                    TMM_Content_Composer::html_option(array(
                                                    'type' => 'select',
                                                    'title' => esc_html__('Fade in effect', TMM_CC_TEXTDOMAIN),
                                                    'shortcode_field' => '',
                                                    'options' => array(
                                                            'bounce' => 'Bounce',
                                                            'swing' => 'Swing',
                                ...
                                <td style="width:15%">
                                    ...
                                    TMM_Content_Composer::html_option(array(
                                                    'type' => 'select',
                                                    'title' => esc_html__('Fade out effect', TMM_CC_TEXTDOMAIN),
                                                    'shortcode_field' => '',
                                                    'options' => array(                                                                                    
                                                            'swing' => 'Swing',
                                                            'wobble' => 'Wobble',
						...
						<tr>
							<td style="width:22%">
                                ...
                                TMM_Content_Composer::html_option(array(
                                            'type' => 'textarea',
                                            'title' => esc_html__('Title Text 2', TMM_CC_TEXTDOMAIN),
