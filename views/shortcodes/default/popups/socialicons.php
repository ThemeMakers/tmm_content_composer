...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
    ...
    <div class="fullwidth">
        ...
        <a class="button button-secondary js_add_list_item"
                ...
                <li class="list_item tmm-mover">
                    <table class="list-table">
                        <tr>
                            ...
                            <td>
                                <a class="button button-secondary js_delete_list_item"
...
<script type="text/javascript">
    ...
    jQuery(function () {
        ...
        jQuery(document.body).on('click', '.js_delete_list_item', function (e) {
            e.preventDefault();
