...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<div class="one-half">
		...
		TMM_Content_Composer::html_option(array(
			'type' => 'checkbox',
			'title' => __('Show the direction keys', TMM_CC_TEXTDOMAIN),
			'shortcode_field' => 'show_keys',
			'id' => 'show_keys',
			'is_checked' => TMM_Content_Composer::set_default_value('show_keys', 0),
			'description' => __('Show/Hide Direction Keys', TMM_CC_TEXTDOMAIN)
		));
		?>
