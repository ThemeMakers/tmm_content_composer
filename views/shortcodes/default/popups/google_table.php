...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
	...
	<h4 for="google_table_headers" class="label"><?php _e('Table headers', 'tmm_content_composer'); ?></h4>
	...
	<h4 for="google_table" class="label"><?php _e('Table data', 'tmm_content_composer'); ?></h4>
	<ul id="google_table">
