...
switch ($type) {
    case 'youtube':
        ...
        <div class="bordered">
            <figure class="add-border">
                <iframe  allowtransparency="true" width="<?php echo $width ?>" height="<?php echo $height ?>" src="https://www.youtube.com/embed/<?php echo $content ?>?wmode=transparent" frameborder="0" allowfullscreen></iframe>
            </figure>
        </div>
    ...
    case 'vimeo':
        ...
        <div class="bordered">
            <figure class="add-border">
                <iframe  width="<?php echo $width ?>" height="<?php echo $height ?>" src="https://player.vimeo.com/video/<?php echo $content ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=f6e200" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
            </figure>
        </div>
        <?php
        break;
