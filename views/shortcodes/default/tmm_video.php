...
switch ($video_type) {
	...
	case $video_types[1]:
		...
		?>
		<iframe <?php echo (isset($width) && !empty($width)) ? 'width="'.$width.'"' : ''; ?> <?php echo (!isset($width) || empty($width) || !isset($height)) ? '' : 'height="'.$height.'"';  ?> src="http://www.youtube.com/embed/<?php echo $source_code ?>?wmode=transparent&amp;rel=0&amp;showinfo=0" allowFullScreen></iframe>
		<?php
