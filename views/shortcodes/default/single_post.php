            ...
            switch ($post_pod_type) {
                                                            ...
                                                            <div class="item">
                                                                <a class="slide-image link-icon" href="<?php echo $post_link; ?>">
                                                                    <?php if ($_REQUEST['sidebar_position'] != 'no_sidebar'){ ?>
                                                                            <img src="<?php echo TMM_Content_Composer::resize_image($source_url, $image_size); ?>" alt="<?php echo $post->post_title; ?>" />
                                                                    <?php }else{ ?>
                                                                            <img src="<?php echo TMM_Content_Composer::resize_image($source_url, $image_size); ?>" alt="<?php echo $post->post_title; ?>" />
                                                                    <?php } ?>                                                                                                           			
                                                                </a>
                    ...
                    default:
                            ...
                            <?php if (has_post_thumbnail($post_id)){ ?>      
                                    ...
                                    <a href="<?php echo $post_link ?>" class="slide-image link-icon">
                                        <img src="<?php echo TMM_Content_Composer::get_post_featured_image($post_id, $image_size); ?>" alt="<?php echo $post->post_title ?>" />
                                    </a>                                                       
    ...
    <?php if ($show_post_metadata == 1){ ?>
            <div class="post-meta">
                    ...
                    <?php if (!class_exists('TMM') || !TMM::get_option("blog_listing_show_comments")){ ?>
                            <span class="comments"><a href="<?php echo $post_link ?>#comments"><?php echo get_comments_number($post->ID); ?></a>&nbsp;<?php _e('Comments', TMM_CC_TEXTDOMAIN); ?></span>
                    <?php } ?>
            </div>
    <?php } ?>    
