...
<div id="tmm_shortcode_template" class="tmm_shortcode_template clearfix">
    ...
    <div class="fullwidth">
        ...
        <a class="button button-secondary js_add_accordion_item"
           href="#"><?php _e('Add item', TMM_CC_TEXTDOMAIN); ?></a>
                ...
                <li class="list_item">
                    <table class="list-table">
                        <tr>
                            ...
                            <td>
                                <a class="button button-secondary js_delete_accordion_item js_shortcode_template_changer"
                                   href="#"><?php _e('Remove', TMM_CC_TEXTDOMAIN); ?></a></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="one-half">
...
<script type="text/javascript">
    ...
    jQuery(function () {
        ...
        jQuery(document.body).on('change', '.icon_type', function () {
            var $this = jQuery(this),
                val = $this.val(),
