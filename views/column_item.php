...
<div class="tmm-lc-column-wrapper <?php echo $css_class ?>">
	...
	<div class="tmm-lc-column" id="item_<?php echo $uniqid ?>">
		...
		<div class="tmm-lc-column-title"><?php echo empty($title) ? esc_html__('Empty title', TMM_CC_TEXTDOMAIN) : $title; ?></div>

		<div class="tmm-lc-column-bar-right">
			<a title="<?php esc_html_e("Edit", TMM_CC_TEXTDOMAIN) ?>" class="tmm-lc-edit-column" data-item-id="<?php echo $uniqid ?>"></a>
			<a title="<?php esc_html_e("Delete", TMM_CC_TEXTDOMAIN) ?>" class="tmm-lc-delete-column" data-item-id="<?php echo $uniqid ?>"></a>
		</div>
