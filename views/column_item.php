...
<div class="tmm-lc-column-wrapper <?php echo $css_class ?>">
	...
	<div class="tmm-lc-column" id="item_<?php echo $uniqid ?>">
		...
		<div class="tmm-lc-column-bar-right">
			<a title="<?php esc_html_e("Edit", 'tmm_content_composer') ?>" class="tmm-lc-edit-column" data-item-id="<?php echo $uniqid ?>"></a>
			<a title="<?php esc_html_e("Delete", 'tmm_content_composer') ?>" class="tmm-lc-delete-column" data-item-id="<?php echo $uniqid ?>"></a>
		</div>
