...
<div class="tmm-lc-column-wrapper <?php echo $css_class ?>">
	...
	<div class="tmm-lc-column" id="item_<?php echo $uniqid ?>">
		...
		<div class="tmm-lc-column-title"><?php echo empty($title) ? __('Empty title', 'cardealer') : $title; ?></div>

		<div class="tmm-lc-column-bar-right">
			<a title="<?php _e("Edit", 'cardealer') ?>" class="tmm-lc-edit-column" data-item-id="<?php echo $uniqid ?>"></a>
			<a title="<?php _e("Delete", 'cardealer') ?>" class="tmm-lc-delete-column" data-item-id="<?php echo $uniqid ?>"></a>
		</div>
