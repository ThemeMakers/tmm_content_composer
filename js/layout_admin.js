                ...
                var popup_params = {
                    ...
                    open: function() {
                        ...
                        var cur_popup = $('.tmm-popup-edit-row'),
	                        ...
	                        border_type = $('#row_border_type_' + row_id).val(),
	                        border_width = $('#row_border_width_' + row_id).val(),
	                        border_color = $('#row_border_color_' + row_id).val(),
	                    ...
	                    cur_popup.find('#row_border_type').val(border_type);
	                    cur_popup.find('#row_border_width').val(border_width);
	                    cur_popup.find('#row_border_color').val(border_color).next('.bgpicker').css('background-color', border_color);
                    ...
                    save: function() {
	                    var cur_popup = $('.tmm-popup-edit-row'),
		                    ...
		                    border_type = cur_popup.find('#row_border_type').val(),
		                    border_width = cur_popup.find('#row_border_width').val(),
		                    border_color = cur_popup.find('#row_border_color').val(),
	                    ...
	                    $('#row_border_type_' + row_id).val(border_type);
	                    $('#row_border_width_' + row_id).val(border_width);
	                    $('#row_border_color_' + row_id).val(border_color);
